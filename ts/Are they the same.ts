...
//     144, 361 the square of 19, 25921 the square of 161, and so on. It gets obvious if we write b's elements in
//     terms of squares:
//
//      a = [121, 144, 19, 161, 19, 144, 19, 11]
...
export function comp(a1: number[] | null, a2: number[] | null): boolean {
    ...
    for (let i = 0; i < a2.length; i++) {
        const indexOfSame = a1.indexOf(Math.sqrt(a2[i]))
        if (indexOfSame === -1) return false;
        a1[indexOfSame] = 0;
    }
    return true;
}
